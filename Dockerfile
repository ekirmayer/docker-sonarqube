...
RUN groupadd -r sonarqube && useradd -r -g sonarqube sonarqube && rm -rf /var/lib/apt/lists/*
...
COPY --from=builder --chown=sonarqube:sonarqube /opt/sonarqube /opt/sonarqube
# Http port
EXPOSE 9000
